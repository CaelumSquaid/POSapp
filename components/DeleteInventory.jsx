...
function DeleteInventory({ datas }) {
      ...
      >
        ...
        <div className="text-gray-700 fixed p-9 bg-gray-50 rounded top-12 left-1/2 transform -translate-x-1/2 overflow-auto max-h-[80vh] w-[30vw]">
          <Dialog.Title className="flex items-center justify-center space-x-4 font-black mb-9">
            ...
            <h6 className="text-3xl">Delete Inventory</h6>
          </Dialog.Title>
          <Formik
          ...
          >
            {() => {
              return (
                <Form>
                  <FormInput name="description" label="Item Description" disabled />
                  <FormInput name="price" label="Price" disabled />
                  <FormInput name="unit" label="Unit" disabled />
